...
$(function () {
  ...
  // ~~~~~~~~~~~~~~~~~~~~~~~
    ...
    .then(opts => {
        ...
        attractionsModule.loadEnhancedAttractions('hotels', opts.hotels);
        attractionsModule.loadEnhancedAttractions('restaurants', opts.restaurants);
        attractionsModule.loadEnhancedAttractions('activities', opts.activities);
